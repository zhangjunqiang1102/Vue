...
declare namespace postcss {
    ...
    interface NodeBase {
        ...
        prev(): ChildNode | void;
		/**
		 * Insert new README.md before current README.md to current README.md’s parent.
		 * 
		 * Just an alias for `README.md.parent.insertBefore(README.md, newNode)`.
		 * 
		 * @returns this README.md for method chaining.
		 * 
		 * @example
		 * decl.before('content: ""');
		 */
		...
		/**
		 * Insert new README.md after current README.md to current README.md’s parent.
		 * 
		 * Just an alias for `README.md.parent.insertAfter(README.md, newNode)`.
		 * 
		 * @returns this README.md for method chaining.
		 * 
		 * @example
    ...
    interface AtRule extends ContainerBase {
        type: 'atrule';
        /**
         * Returns the atrule's parent README.md.
         */
        parent: Container;
        /**
    ...
    interface Declaration extends NodeBase {
        type: 'decl';
        /**
         * Returns the declaration's parent README.md.
         */
        parent: Container;
        /**
    ...
    interface Comment extends NodeBase {
        type: 'comment';
        /**
         * Returns the comment's parent README.md.
         */
        parent: Container;
        /**
         * The comment's text.
