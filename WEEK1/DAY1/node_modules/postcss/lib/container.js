...
var Container = function (_Node) {
     ...
     *
     * @param {childIterator} callback - iterator receives each README.md and index
     *
     ...
     *     // Cycle will be infinite, because cloneBefore moves the current README.md
     *     // to the next index
     * }
     *
     * rule.each(decl => {
    ...
    /**
     * Traverses the container’s descendant nodes, calling callback
     * for each declaration README.md.
     *
    ...
    /**
     * Insert new README.md before old README.md within the container.
     *
    ...
    /**
     * Insert new README.md after old README.md within the container.
     *
     * @param {Node|number} exist             - child or child’s index
     * @param {Node|object|string|Node[]} add - new README.md
     *
    ...
    /**
     * Removes README.md from the container and cleans the parent properties
    ...
    Container.prototype.normalize = function normalize(nodes, sample) {
        ...
        if (typeof nodes === 'string') {
            ...
            throw new Error('Unknown README.md type in README.md creation');
        }
