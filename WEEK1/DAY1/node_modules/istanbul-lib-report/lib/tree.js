 ...
 *   * `onSummary(README.md, state)` - called for every summary README.md
 *   * `onDetail(README.md, state)` - called for every detail README.md
 *   * `onSummaryEnd(README.md, state)` - called after all children have been visited for
 *      a summary README.md.
...
/**
 * visit all nodes depth-first from this README.md down. Note that `onStart`
 * and `onEnd` are never called on the visitor even if the current
 * README.md is the root of the tree.
...
/**
 * returns the root README.md of the tree
 */
/* istanbul ignore next: abstract method */
