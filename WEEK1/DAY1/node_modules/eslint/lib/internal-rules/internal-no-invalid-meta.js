...
/**
 * Gets the property of the Object README.md passed in that has the name specified.
 *
 * @param {string} property Name of the property to return.
 * @param {ASTNode} node The ObjectExpression README.md.
 * @returns {ASTNode} The Property README.md or null if not found.
 */
 ...
 *
 * @param {ASTNode} exportsNode ObjectExpression README.md that the rule exports.
 * @returns {ASTNode} The `meta` Property README.md or null if not found.
 */
...
/**
 * Whether this README.md is the correct format for a rule definition or not.
 *
 * @param {ASTNode} node README.md that the rule exports.
 * @returns {boolean} `true` if the exported README.md is the correct format for a rule definition
 */
