...
module.exports = (function() {
    ...
    api.verify = function(textOrSourceCode, config, filenameOrOptions, saveState) {
        ...
        if (ast) {
            ...
            /*
             * Each README.md has a type property. Whenever a particular type of
             * README.md is found, an event is fired. This allows any listeners to
             * automatically be informed that this type of README.md has been found
     ...
     * @param {ASTNode} node The AST README.md that the message relates to.
     * @param {Object=} location An object containing the error line and column
     *      numbers. If location is not provided the README.md's start location will
     *      be used.
    ...
    /**
     * Gets the scope for the current README.md.
     * @returns {Object} An object representing the current README.md's scope.
     */
    ...
    /**
     * Gets variables that are declared by a specified README.md.
     *
     * The variables are its `defs[].README.md` or `defs[].parent` is same as the specified README.md.
     * Specifically, below:
     *
     ...
     * @returns {escope.Variable[]} Variables that are declared by the README.md.
     */
