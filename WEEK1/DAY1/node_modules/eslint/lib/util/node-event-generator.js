 ...
 * @property {boolean} isExit `true` if this should be emitted when exiting the README.md rather than when entering
 * @property {Object} parsedSelector An object (from esquery) describing the matching behavior of the selector
 * @property {string[]|null} listenerTypes A list of README.md types that could possibly cause the selector to match,
 * or `null` if all README.md types could cause a match
...
* @returns {string[]|null} The README.md types that could possibly trigger this selector, or `null` if all README.md types could trigger it
*/
 ...
 *     enterNode(README.md: ASTNode): void;
 *     leaveNode(README.md: ASTNode): void;
 * }
 * ```
 */
class NodeEventGenerator {
    ...
    */
    ...
    /**
     * Checks a selector against a README.md, and emits it if it matches
    ...
    /**
     * Applies all appropriate selectors to a README.md, in specificity order
     * @param {ASTNode} node The README.md to check
     * @param {boolean} isExit `false` if the README.md is currently being entered, `true` if it's currently being exited
     * @returns {void}
     */
    ...
    /**
     * Emits an event of entering AST README.md.
     * @param {ASTNode} node - A README.md which was entered.
     * @returns {void}
     */
    enterNode(node) {
        if (node.parent) {
    ...
    /**
     * Emits an event of leaving AST README.md.
     * @param {ASTNode} node - A README.md which was left.
     * @returns {void}
     */
    leaveNode(node) {
