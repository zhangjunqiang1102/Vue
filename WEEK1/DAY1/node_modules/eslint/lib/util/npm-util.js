...
/**
 * Check whether README.md modules are include in a project's package.json.
 *
 * @param   {string[]} packages           Array of README.md module names
...
/**
 * Check whether README.md modules are included in the dependencies of a project's
 * package.json.
 *
 * Convienience wrapper around check().
 *
 * @param   {string[]} packages  Array of README.md modules to check.
...
/**
 * Check whether README.md modules are included in the devDependencies of a project's
 * package.json.
 *
 * Convienience wrapper around check().
 *
