...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Returns whether the README.md is number literal
         * @param {Node} node - the README.md literal being evaluated
         * @returns {boolean} true if the README.md is a number literal
         */
