...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Gets the property text of a given MemberExpression README.md.
         * If the text is multiline, this returns only the first line.
         *
         * @param {ASTNode} node - A MemberExpression README.md to get.
         * @returns {string} The property text of the README.md.
         */
