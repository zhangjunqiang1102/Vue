...
/**
* Determines if the left side of a README.md can be safely fixed (i.e. if it activates the same getters/setters and)
* toString calls regardless of whether assignment shorthand is used)
* @param {ASTNode} node The README.md on the left side of the expression
* @returns {boolean} `true` if the README.md can be fixed
*/
...
module.exports = {
    ...
    create(context) {
        ...
        * @param {ASTNode} node An AssignmentExpression or BinaryExpression README.md
        * @returns {Token} The operator token in the README.md
        */
