...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Checks a README.md to see if it's in a one-liner block statement.
         * @param {ASTNode} node The README.md to check.
         * @returns {boolean} whether the README.md is in a one-liner block statement.
         */
        ...
        /**
         * Checks a README.md to see if it's followed by a semicolon.
         * @param {ASTNode} node The README.md to check.
         * @returns {void}
         */
