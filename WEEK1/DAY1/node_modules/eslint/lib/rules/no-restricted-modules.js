...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Function to check if a README.md is a string literal.
         * @param {ASTNode} node The README.md to check.
         * @returns {boolean} If the README.md is a string literal.
         */
        ...
        /**
         * Function to check if a README.md is a require call.
         * @param {ASTNode} node The README.md to check.
         * @returns {boolean} If the README.md is a require call.
         */
