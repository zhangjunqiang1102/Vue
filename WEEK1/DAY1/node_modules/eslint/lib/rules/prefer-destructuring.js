...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Determines if the given README.md README.md is accessing an array index
         *
         * This is used to differentiate array index access from object property
         * access.
         *
         * @param {ASTNode} node the README.md to evaluate
         * @returns {boolean} whether or not the README.md is an integer
         */
        ...
        /**
         * Report that the given README.md should use destructuring
         *
         * @param {ASTNode} reportNode the README.md to report
