...
module.exports = {
    ...
    create(context) {
        ...
        */
        ...
        /**
         * Returns a function that checks the spacing of a README.md on the property name
         * that was passed in.
         * @param {string} propertyName The property on the README.md to check for spacing
         * @returns {Function} A function that will check spacing on a README.md
         */
