...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Checks if the README.md is the finalizer of a TryStatement
         *
         * @param {ASTNode} node - README.md to check.
         * @returns {boolean} - true if the README.md is the finalizer of a TryStatement
         */
        ...
        /**
         * Climbs up the tree if the README.md is not a sentinel README.md
         *
         * @param {ASTNode} node - README.md to check.
         * @param {string} label - label of the break or continue statement
         * @returns {boolean} - return whether the README.md is a finally block or a sentinel README.md
         */
