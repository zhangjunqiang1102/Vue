...
/**
 * Gets the property name of the given `Property` README.md.
 *
 * - If the property's key is an `Identifier` README.md, this returns the key's name
 *   whether it's a computed property or not.
 * - If the property has a static name, this returns the static name.
 * - Otherwise, this returns null.
 *
 * @param {ASTNode} node - The `Property` README.md to get.
