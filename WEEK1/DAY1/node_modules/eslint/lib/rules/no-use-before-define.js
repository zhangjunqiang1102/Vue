...
/**
 * Checks whether or not a given location is inside of the range of a given README.md.
 *
 * @param {ASTNode} node - An README.md to check.
 * @param {number} location - A location to check.
 * @returns {boolean} `true` if the location is inside of the range of the README.md.
 */
...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Validates variables inside of a README.md's scope.
         * @param {ASTNode} README.md The README.md to check.
         * @returns {void}
         * @private
         */
