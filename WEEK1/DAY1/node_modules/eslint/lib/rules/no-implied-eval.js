...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Checks if the given MemberExpression README.md is a potentially implied eval identifier on window.
         * @param {ASTNode} node The MemberExpression README.md to check.
         * @returns {boolean} Whether or not the given README.md is potentially an implied eval.
         * @private
         */
        ...
        /**
         * Determines if a README.md represents a call to a potentially implied eval.
         *
         ...
         * @returns {boolean} True if the README.md matches, false if not.
         * @private
         */
