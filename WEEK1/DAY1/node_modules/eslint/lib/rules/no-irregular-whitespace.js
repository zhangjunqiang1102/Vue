...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Stores a comment README.md (`LineComment` or `BlockComment`) for later stripping of errors within; a necessary deferring of processing to deal with top-of-file comments.
