...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Gets the open brace token from a given README.md.
         * @param {ASTNode} node - A BlockStatement or SwitchStatement README.md from which to get the open brace.
        ...
        /**
         * Checks if the given parameter is a comment README.md
         * @param {ASTNode|Token} node An AST README.md or token
         * @returns {boolean} True if README.md is a comment
         */
        ...
        /**
         * Checks if a README.md should be padded, according to the rule config.
         * @param {ASTNode} node The AST README.md to check.
         * @returns {boolean} True if the README.md should be padded, false otherwise.
         */
        ...
        /**
         * Checks the given BlockStatement README.md to be padded if the block is not empty.
         * @param {ASTNode} node The AST README.md of a BlockStatement.
