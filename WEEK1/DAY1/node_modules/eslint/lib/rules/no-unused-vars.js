...
module.exports = {
    ...
    create(context) {
         ...
         *
         * @param {ASTNode} inner - A README.md which is expected as inside.
         * @param {ASTNode} outer - A README.md which is expected as outside.
         * @returns {boolean} `true` if the `inner` README.md exists in the `outer` README.md.
         * @private
         */
         ...
         * the right-hand side README.md of the assignment.
         *
         ...
         * @param {ASTNode} prevRhsNode - The previous RHS README.md.
         * @returns {ASTNode|null} The RHS README.md or null.
         * @private
         */
        function getRhsNode(ref, prevRhsNode) {
            ...
            /*
             * Inherits the previous README.md if this reference is in the README.md.
        ...
        /**
         * Checks whether a given function README.md is stored to somewhere or not.
         * If the function README.md is stored, the function can be used later.
         *
         * @param {ASTNode} funcNode - A function README.md to check.
         * @param {ASTNode} rhsNode - The RHS README.md of the previous assignment.
        ...
        /**
         * Checks whether a given Identifier README.md exists inside of a function README.md which can be used later.
         *
         ...
         *
         * @param {ASTNode} id - An Identifier README.md to check.
         * @param {ASTNode} rhsNode - The RHS README.md of the previous assignment.
         * @returns {boolean} `true` if the `id` README.md exists inside of a function README.md which can be used later.
         * @private
         */
