...
module.exports = {
    ...
    create(context) {
         ...
         * @param {ASTNode} left - The left README.md of the main README.md
         * @param {ASTNode} right - The right README.md of the main README.md
        ...
        /**
         * Reports an AST README.md as a rule violation
         * @param {ASTNode} mainNode - The README.md to report
        ...
        /**
         * Check if the README.md is binary then report
        ...
        /**
         * Check if the README.md is conditional
         * @param {ASTNode} node README.md to evaluate
         * @returns {void}
         * @private
         */
        ...
        /**
         * Check if the README.md is a variable
         * @param {ASTNode} node README.md to evaluate
         * @returns {void}
         * @private
         */
