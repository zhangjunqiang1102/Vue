...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Reports a given README.md if it violated this rule.
         *
         * @param {ASTNode} node - A README.md to check. This is an ObjectExpression README.md or an ObjectPattern README.md.
