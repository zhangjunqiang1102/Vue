...
module.exports = {
    ...
    create(context) {
        ...
        /**
        * Check if the README.md is the first "!" in a "!!" convert to Boolean expression
        * @param {ASTnode} node AST README.md
        * @returns {boolean} Whether or not the README.md is first "!" in "!!"
        */
        ...
        /**
        * Check if the README.md's child argument is an "ObjectExpression"
        * @param {ASTnode} node AST README.md
        ...
        * @param {ASTnode} node AST README.md
        * @param {Object} firstToken first token from the AST README.md
        * @param {Object} secondToken second token from the AST README.md
