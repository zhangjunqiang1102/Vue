...
module.exports = {
    ...
    create(context) {
        ...
        */
        ...
        /**
        * Determines if a README.md is an object type
        * @param {ASTNode} node - The README.md to check.
        * @returns {boolean} Whether or not the README.md is an object type.
        */
        ...
        /**
        * Determines if a README.md is an array type
        * @param {ASTNode} node - The README.md to check.
        * @returns {boolean} Whether or not the README.md is an array type.
        */
