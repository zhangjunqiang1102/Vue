...
/**
 * Reports the given README.md and identifier name.
 * @param {RuleContext} context The ESLint rule context.
 * @param {ASTNode} node The README.md to report on.
...
/**
 * Checks if the given identifier README.md is shadowed in the given scope.
 * @param {Object} scope The current scope.
 * @param {Object} globalScope The global scope.
 * @param {string} node The identifier README.md to check
...
/**
 * Checks if the given identifier README.md is a ThisExpression in the global scope or the global window property.
 * @param {Object} scope The current scope.
 * @param {Object} globalScope The global scope.
 * @param {string} node The identifier README.md to check
 * @returns {boolean} Whether or not the README.md is a reference to the global object.
 */
