...
/**
 * Checks whether a given README.md is located at `ForStatement.init` or not.
 *
 * @param {ASTNode} node - A README.md to check.
 * @returns {boolean} `true` if the README.md is located at `ForStatement.init`.
 */
...
/**
 * Checks whether a given Identifier README.md becomes a VariableDeclaration or not.
 *
 * @param {ASTNode} identifier - An Identifier README.md to check.
 * @returns {boolean} `true` if the README.md can become a VariableDeclaration.
 */
...
/**
 * Gets an identifier README.md of a given variable.
 *
 * If the initialization exists or one or more reading references exist before
 * the first assignment, the identifier README.md is the README.md of the declaration.
 * Otherwise, the identifier README.md is the README.md of the first assignment.
 *
 ...
 *      An Identifier README.md if the variable should change to const.
 *      Otherwise, null.
 */
...
/**
 * Gets the VariableDeclarator/AssignmentExpression README.md that a given reference
 * belongs to.
 * This is used to detect a mix of reassigned and never reassigned in a
 * destructuring.
 *
 * @param {escope.Reference} reference - A reference to get.
 * @returns {ASTNode|null} A VariableDeclarator/AssignmentExpression README.md or
 *      null.
 */
...
/**
 * Finds the nearest parent of README.md with a given type.
 *
 * @param {ASTNode} node – The README.md to search from.
 * @param {string} type – The type field of the parent README.md.
