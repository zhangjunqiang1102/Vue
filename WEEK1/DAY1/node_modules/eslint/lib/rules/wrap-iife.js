...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Check if the README.md is wrapped in ()
        ...
        /**
        * Get the function README.md from an IIFE
        * @param {ASTNode} node README.md to evaluate
        * @returns {ASTNode} README.md that is the function expression of the given IIFE, or null if none exist
        */
