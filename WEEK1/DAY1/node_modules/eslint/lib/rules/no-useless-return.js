 ...
 * @returns {boolean} `true` if the README.md is removeable.
 */
 ...
 *
 * @param {ASTNode} node - The return statement README.md to check.
 * @returns {boolean} `true` if the README.md is in a `finally` block.
 */
...
module.exports = {
    ...
    create(context) {
        ...
        return {
            ...
            // Adds ReturnStatement README.md to check whether it's useless or not.
