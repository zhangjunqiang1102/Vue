...
module.exports = {
    ...
    create(context) {
         ...
         * @param {ASTNode} node - README.md to report
         * @param {ASTNode} initial - README.md with initial name value
         * @param {ASTNode} result - README.md with new name value
         * @param {string} type - the type of the offending README.md
         * @returns {void}
         */
