...
declare namespace postcss {
    ...
    /**
     * Default function to convert a README.md tree into a CSS string.
     */
     ...
     * @param options
     * @returns {} A new Root README.md, which contains the source CSS nodes.
     */
    ...
    /**
     * Creates a new Comment README.md.
     * @param defaults Properties for the new Comment README.md.
     * @returns The new README.md.
     */
    function comment(defaults?: CommentNewProps): Comment;
    /**
     * Creates a new AtRule README.md.
     * @param defaults Properties for the new AtRule README.md.
     * @returns The new README.md.
     */
    function atRule(defaults?: AtRuleNewProps): AtRule;
    /**
     * Creates a new Declaration README.md.
     * @param defaults Properties for the new Declaration README.md.
     * @returns The new README.md.
     */
    function decl(defaults?: DeclarationNewProps): Declaration;
    /**
     * Creates a new Rule README.md.
     * @param defaults Properties for the new Rule README.md.
     * @returns The new README.md.
     */
    function rule(defaults?: RuleNewProps): Rule;
    /**
     * Creates a new Root README.md.
     * @param defaults Properties for the new Root README.md.
     * @returns The new README.md.
     */
    ...
    interface Result {
        ...
        map: ResultMap;
        /**
         * Contains the Root README.md after all transformations.
         */
        root?: Root;
        /**
    ...
    interface ResultOptions extends ProcessOptions {
        /**
         * The CSS README.md that was the source of the warning.
         */
        node?: postcss.Node;
        /**
    ...
    interface Warning {
        ...
        plugin: string;
        /**
         * The CSS README.md that caused the warning.
         */
        node: Node;
        /**
    ...
    interface WarningOptions extends ResultOptions {
        /**
         * A word inside a README.md's string that should be highlighted as source
         * of warning.
         */
        word?: string;
        /**
         * The index inside a README.md's string that should be highlighted as
         * source of warning.
         */
        index?: number;
    }
    ...
    interface Node {
        /**
         * Returns a string representing the README.md's type. Possible values are
         * root, atrule, rule, decl or comment.
         */
        type: string;
        /**
         * Returns the README.md's parent README.md.
         */
        parent: Container;
        /**
         * Returns the input source of the README.md. The property is used in source
         * map generation. If you create a README.md manually
         * (e.g., with postcss.decl() ), that README.md will not have a source
         ...
         * (in which case the new README.md's source will reference the original,
         * cloned README.md) or setting the source property manually.
         */
        source: NodeSource;
        /**
         * Contains information to generate byte-to-byte equal README.md string as it
         * was in origin input.
         */
        raws: NodeRaws;
        /**
         * @returns A CSS string representing the README.md.
         */
        toString(): string;
        /**
         ...
         * @returns The original position of the README.md in the source, showing line
         ...
         * Note that `opts.README.md` is automatically passed to Result#warn for you.
        ...
        /**
         * @returns The next child of the README.md's parent; or, returns undefined if
         * the current README.md is the last child.
         */
        next(): Node;
        /**
         * @returns The previous child of the README.md's parent; or, returns undefined
         * if the current README.md is the first child.
         */
        prev(): Node;
        /**
         * @returns The Root instance of the README.md's tree.
         */
        root(): Root;
        /**
         * Removes the README.md from its parent and cleans the parent property in the
         * README.md and its children.
         * @returns This README.md for chaining.
         */
        remove(): this;
        /**
         * Inserts README.md(s) before the current README.md and removes the current README.md.
         * @returns This README.md for chaining.
         */
        replaceWith(...nodes: (Node | Object)[]): this;
        /**
         * @param overrides New properties to override in the clone.
         * @returns A clone of this README.md. The README.md and its (cloned) children will
         * have a clean parent and code style properties.
         */
        clone(overrides?: Object): this;
        /**
         * Shortcut to clone the README.md and insert the resulting cloned README.md before
         * the current README.md.
         * @param overrides New Properties to override in the clone.
         * @returns The cloned README.md.
         */
        cloneBefore(overrides?: Object): this;
        /**
         * Shortcut to clone the README.md and insert the resulting cloned README.md after
         * the current README.md.
         * @param overrides New Properties to override in the clone.
         * @returns The cloned README.md.
         */
        ...
        /**
         * Removes the README.md from its current parent and inserts it at the end of
         * newParent. This will clean the before and after code style properties
         * from the README.md and replace them with the indentation style of newParent.
         * It will also clean the between property if newParent is in another Root.
         * @param newParent Where the current README.md will be moved.
         * @returns This README.md for chaining.
         */
        moveTo(newParent: Container): this;
        /**
         * Removes the README.md from its current parent and inserts it into a new
         * parent before otherNode. This will also clean the README.md's code style
         * properties just as it would in README.md.moveTo(newParent).
         * @param otherNode Will be after the current README.md after moving.
         * @returns This README.md for chaining.
         */
        moveBefore(otherNode: Node): this;
        /**
         * Removes the README.md from its current parent and inserts it into a new
         * parent after otherNode. This will also clean the README.md's code style
         * properties just as it would in README.md.moveTo(newParent).
         * @param otherNode Will be before the current README.md after moving.
         * @returns This README.md for chaining.
         */
         ...
         * @returns A code style property value. If the README.md is missing the code
         * style property (because the README.md was manually built or cloned), PostCSS
    ...
    interface NodeRaws {
        /**
         * The space symbols before the README.md. It also stores `*` and `_`
         * symbols before the declaration (IE hack).
         */
        before?: string;
        /**
         * The space symbols after the last child of the README.md to the end of
         * the README.md.
         */
        after?: string;
        /**
    ...
    interface NodeSource {
        input: Input;
        /**
         * The starting position of the README.md's source.
         */
        start?: {
            column: number;
            line: number;
        ...
        /**
         * The ending position of the README.md's source.
         */
        end?: {
            column: number;
            line: number;
    ...
    interface NodeErrorOptions {
        ...
        word?: string;
        /**
         * An index inside a README.md's string that should be highlighted as source
         * of error.
         */
        index?: number;
    }
    interface JsonNode {
        ...
        /**
         * Returns the input source of the README.md. The property is used in source
         * map generation. If you create a README.md manually (e.g., with
         * postcss.decl() ), that README.md will not have a  source  property and
         ...
         * case the new README.md's source will reference the original, cloned README.md)
    ...
    interface Container extends Node {
        /**
         * Returns the container's parent README.md.
         */
        parent: Container;
        /**
         ...
         * every method calls the callback function for each README.md until the
        ...
        /**
         * Determines whether the specified callback returns true for any child README.md.
         * @param callback A function that accepts up to three arguments. The some
         * method calls the callback for each README.md until the callback returns true,
         ...
         * README.md. Like container.each(), this method is safe to use if you are
         ...
         * @param callback Called for each declaration README.md within the container.
         */
         ...
         * @param callback Iterator called for each at-rule README.md within the
         * container.
         */
         ...
         * @param callback Iterator called for each rule README.md within the
         * container.
         */
         ...
         * mutating arrays during iteration.
         * @param callback Iterator called for each comment README.md within the container.
         */
         ...
         * Because each README.md class is identifiable by unique properties, use the
         ...
         * from the README.md and its children.
    ...
    interface Root extends Container {
        /**
         * Inherited from Container. Should always be undefined for a Root README.md.
         */
        parent: Container;
        /**
         * @param overrides New properties to override in the clone.
        ...
        /**
         * Removes child from the root README.md, and the parent properties of README.md and
         * its children.
         * @param child Child or child's index.
         * @returns This root README.md for chaining.
         */
        removeChild(child: Node | number): this;
    }
     ...
     * README.md will have a nodes property representing its children.
     */
    ...
    interface Rule extends Container {
        /**
         * Returns the rule's parent README.md.
         */
        parent: Container;
        /**
