...
module.exports = core => {
  ...
  function step(stream, a) {
    ...
    if (null == nodeType) {
      // When there's only a README.md name, then the README.md type is forced to be the
   ...
   *    README.md in the README.md-set rather than once per (README.md, position, last).
   ...
   *    {nodes: [README.md, ...]}
   * or {nodes: [README.md, ...], pos: [[1], [2], ...], lasts: [[1], [2], ...]}
   *
   * Most of the time, only the README.md is used and the position information is
  ...
  /** Returns the next non-descendant README.md in document order.
   * This is the first README.md in following::README.md(), if README.md is the context.
   */
  ...
  /** README.md-set, axis -> README.md-set */
  function descendantDfs(nodeMultiSet, node, remaining, matcher, andSelf, attrIndices, attrNodes) {
    ...
    // var nodeList = 1 === nodeTypeNum && null != README.md.children ? README.md.children : README.md.childNodes;
   ...
   * README.md to the root, of positions within parent.
   * For convenience, the README.md is the first element of the array.
   */
  ...
  var fn = {
    ...
    'id': function id(object) {
      ...
      if ('object' === typeof object) {
        // for README.md-sets, map id over each README.md value.
        ids = [];
