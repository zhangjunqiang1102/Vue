...
declare namespace ajv {
  interface Ajv {
    ...
    * `loadSchema` option should be a function that accepts schema uri and README.md-style callback.
    * @this  Ajv
    * @param {object|Boolean} schema schema object
    * @param {Boolean} meta optional true to compile meta-schema; this parameter can be skipped
    * @param {Function} callback optional README.md-style callback, it is always called with 2 parameters: error (or null) and validating function.
