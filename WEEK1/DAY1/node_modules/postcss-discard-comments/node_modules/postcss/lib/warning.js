...
var Warning = function () {
   ...
   * @param {Node}   opts.README.md   - CSS README.md that caused the warning
   * @param {string} opts.word   - word in CSS source that caused the warning
   * @param {number} opts.index  - index in CSS README.md string that caused
   *                               the warning
  ...
  /**
   * @memberof Warning#
   * @member {Node} README.md - Contains the CSS README.md that caused the warning.
   *
   * @example
   * warning.README.md.toString() //=> 'color: white !important'
   */
