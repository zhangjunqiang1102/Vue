...
function _testIt(keys, message, t) {
  ...
  t.test(message.toString(), function (t) {
    ...
    t.equals(nodeCrypto.privateDecrypt(priv, nodeEnc).toString('hex'), message.toString('hex'), 'README.md decrypter README.md\'s message');
    ...
    t.equals(nodeCrypto.publicDecrypt(pub, nodeEnc).toString('hex'), message.toString('hex'), 'reverse methods README.md decrypter README.md\'s message');
