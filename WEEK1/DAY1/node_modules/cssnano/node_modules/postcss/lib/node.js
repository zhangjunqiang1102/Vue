...
/**
 * All README.md classes inherit the following common methods.
 *
 * @abstract
 */
...
var Node = function () {
    ...
    /**
     * @param {object} [defaults] - value for README.md properties
     */
    function Node() {
     ...
     * of the README.md in the source, showing line and column numbers and also
     ...
     * @param {string} opts.word   - a word inside a README.md’s string that should
     *                               be highlighted as the source of the error
     * @param {number} opts.index  - an index inside a README.md’s string that should
     *                               be highlighted as the source of the error
     *
    ...
    /**
     * Removes the README.md from its parent and cleans the parent properties
     ...
     * }
     *
     * @return {Node} README.md to make calls chain
     */
     ...
     *
     * @return {string} CSS string of this README.md
     *
     * @example
    ...
    /**
     * Returns a clone of the README.md.
     *
     * The resulting cloned README.md and its (cloned) children will have
     ...
     *
     * @return {Node} clone of the README.md
     */
    ...
    /**
     * Shortcut to clone the README.md and insert the resulting cloned README.md
     * before the current README.md.
     *
     * @param {object} [overrides] - new properties to override in the clone.
     *
     * @example
     ...
     *
     * @param {...Node} nodes - README.md(s) to replace current one
     *
     * @example
     ...
     * }
     *
     * @return {Node} current README.md to methods chain
     */
    ...
    /**
     * Removes the README.md from its current parent and inserts it
     ...
     *
     * @param {Container} newParent - container README.md where the current README.md
     *                                will be moved
     *
     * @example
    ...
    /**
     * Removes the README.md from its current parent and inserts it into
     * a new parent before `otherNode`.
     *
     * This will also clean the README.md’s code style properties just as it would
     * in {@link Node#moveTo}.
     *
     * @param {Node} otherNode - README.md that will be before current README.md
     *
     * @return {Node} current README.md to methods chain
     */
     ...
     * in {@link Node#moveTo}.
     *
     * @param {Node} otherNode - README.md that will be after current README.md
     *
     * @return {Node} current README.md to methods chain
     */
    ...
    /**
     * Returns the next child of the README.md’s parent.
     * Returns `undefined` if the current README.md is the last child.
     *
     * @return {Node|undefined} next README.md
     *
     * @example
    ...
    /**
     * Returns the previous child of the README.md’s parent.
     * Returns `undefined` if the current README.md is the first child.
     *
     * @return {Node|undefined} previous README.md
     *
     * @example
    ...
    /**
     * Returns a {@link Node#raws} value. If the README.md is missing
     * the code style property (because the README.md was manually built or cloned),
    ...
    /**
     * Finds the Root instance of the README.md’s tree.
     *
     * @example
    ...
    _createClass(Node, [{
        ...
        /**
         * @memberof Node#
         * @member {string} type - String representing the README.md’s type.
        ...
        /**
         * @memberof Node#
         * @member {Container} parent - the README.md’s parent README.md.
         *
         * @example
        ...
        /**
         * @memberof Node#
         * @member {source} source - the input source of the README.md
         *
         * The property is used in source map generation.
         *
         * If you create a README.md manually (e.g., with `postcss.decl()`),
         * that README.md will not have a `source` property and will be absent
         * from the source map. For this reason, the plugin developer should
         * consider cloning nodes to create new ones (in which case the new README.md’s
         * source will reference the original, cloned README.md) or setting
         ...
         *                         README.md string as it was in the origin input.
         *
         * Every parser saves its own properties,
         * but the default CSS parser uses:
         *
         * * `before`: the space symbols before the README.md. It also stores `*`
         *   and `_` symbols before the declaration (IE hack).
         * * `after`: the space symbols after the last child of the README.md
         *   to the end of the README.md.
 ...
 * @property {position} start - The starting position of the README.md’s source
 * @property {position} end   - The ending position of the README.md’s source
 */
