...
/**
 * Gets the name of a given README.md.
 *
 * @param {ASTNode} node - An Identifier README.md to get.
 * @returns {string} The name of the README.md.
 */
...
function create(context) {
    ...
    /**
     * Reports a given README.md if the specified feature is not supported.
     *
     * @param {ASTNode} node - A README.md to be reported.
