...
/**
 * Gets the property name from a MemberExpression README.md or a Property README.md.
 *
 * @param {ASTNode} node - A README.md to get.
 * @returns {string|null} The property name of the README.md.
 */
...
/**
 * Checks a given README.md is a ImportDeclaration README.md.
 *
 * @param {ASTNode} node - A README.md to check.
 * @returns {boolean} `true` if the README.md is a ImportDeclaration README.md.
 */
...
/**
 * Finds the variable object of a given Identifier README.md.
 *
 * @param {ASTNode} node - An Identifier README.md to find.
...
/**
 * Gets the top member expression README.md.
 *
 * @param {ASTNode} identifier - The README.md to get.
 * @returns {ASTNode} The top member expression README.md.
 */
...
function create(context) {
    ...
    /**
     * Checks violations in a ModuleSpecifier README.md.
     *
     * @param {ASTNode} node - A ModuleSpecifier README.md to check.
     * @param {string[]} path - The path to a deprecated property.
     * @param {object} infoMap - A map of properties' information.
     * @returns {void}
     */
